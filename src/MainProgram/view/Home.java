    ...
    public void launch() {
        ...
        getController().getZoomingEffectBtn().hoverProperty().addListener((observableValue, aBoolean, t1) -> {
            ...
            if (t1) {
                ...
                getController().getDescription().setText("  A zoom lens is a mechanical assembly of lens elements for" +
                        " which the focal length (and thus angle of view) can be varied, as opposed to a fixed focal" +
        ...
        getController().getSphericalAberrationBtn().hoverProperty().addListener((observableValue, aBoolean, t1) -> {
            ...
            if (t1) {
                ...
                getController().getDescription()
                        .setText("  Spherical aberration is a type of aberration found in optical systems that use" +
                                " elements with spherical surfaces. Lenses and curved mirrors are most often made" +
                                " with surfaces that are spherical, because this shape is easier to form than" +
                                " non-spherical curved surfaces. Light rays that strike a spherical surface" +
                                " off-centre are refracted or reflected more or less than those that strike" +
                                " close to the centre. This deviation reduces the quality of images produced" +
                                " by optical systems.");
            } else {
                getController().getSphericalAberrationBtn()
                        .setStyle("-fx-background-color: transparent;" +
        ...
        getController().getFreeModeBtn().hoverProperty().addListener((observableValue, aBoolean, t1) -> {
            ...
            if (t1) {
                ...
                getController().getDescriptionImage()
                        .setImage(new Image("Framework/LSD/views/IMAGE/triplet-chief.png"));
                getController().getDescription()
